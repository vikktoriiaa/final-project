    ...
    <main className="dark:bg-[#2e3040] dark:text-white">
      <section className="relative h-screen bg-[url('../../bg.png')] bg-no-repeat bg-cover">
        ...
        <div className="relative xl:py-40 xl:pl-20 xl:pr-120 lg:py-20 lg:pl-10 lg:pr-60 md:py-10 md:pl-10 md:pr-30 xs:py-5 xs:pl-5 xs:pr-15 text-white xxs:p-5">
          ...
          <p className="font-normal text-base/7 pb-4">By <span className="text-yellow">James West</span> |  May 23, 2022 </p>
          ...
          <Button text="Read More >" background="bg-yellow" color="text-black" func={navigateToAboutUs}/>
        </div>
      </section>
      <section className="flex md:flex-row xxs:flex-col md:py-32 md:px-20 xxs:py-10 xxs:px-5 gap-8">
        <div>
          ...
          <div className="mt-8 border border-[#96969a] p-4">
            ...
            <p className="font-normal xl:text-base/7 md:text-normal/5 text-medium-gray pt-4 pb-8 hidden md:block">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident.</p>
            <Button text="Read More >" background="bg-yellow" color="text-black" func={ navigateToAboutUs }/>
          </div>
        </div>
        <div>
          ...
          <div className="mt-8 flex flex-col gap-4">
            ...
            <Post title="8 Figma design systems that you can download for free today." date="Aug 23, 2021" bg={"bg-light-yellow"} />
            <Post title="8 Figma design systems that you can download for free today." date="Aug 23, 2021" />
            <Post title="8 Figma design systems that you can download for free today." date="Aug 23, 2021" hidden="hidden lg:block" />
          </div>
        </div>
      </section>
      <section className="relative flex justify-around my-10 xl:mx-20 xss:mx-10 bg-light-purple before:content-[''] before:w-[70%] before:h-[5%] before:bg-gradient-to-r before:from-purple before:to-yellow before:absolute before:-top-5 before:right-0 before:-z-10 dark:text-black">
        <div className="flex md:flex-row xxs:flex-col xl:py-20 xl:px-20 lg:py-10 lg:px-10 md:py-5 md:px-5 xxs:py-4 xxs:px-4 xl:gap-20 md:gap-10 xxs:gap-5">
          <div className="flex flex-col gap-6">
            ...
            <p className="font-normal text-base/7 text-medium-gray">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            <Button text="Read More >" background="bg-light-purple" color='text-purple' func={ navigateToAboutUs } />
          </div>
          <div className="flex flex-col gap-5">
            ...
            <p className="font-normal text-base/7 text-medium-gray">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
          </div>
        </div>
      </section>
      <section className="flex flex-col justify-center items-center lg:gap-10 xxs:gap-5 mx-auto md:my-30 xxs:my-15 lg:px-20 xxs:px-5">
        ...
        <div className="flex gap-8 md:flex-nowrap xxs:flex-wrap justify-center">
          ...
          <CardCategory background="bg-yellow" icon="../../shuttle.svg" text="Lorem ipsum dolor sit amet, consectetuer adipiscing elit." title="Startup" />
      ...
      <section className="xl:relative hidden bg-[url('../../bg-section.png')] content-[''] w-[949px] h-[705px] xl:flex justify-center items-end mx-30">
        <div className="absolute flex flex-col gap-6 bg-white max-w-[706px] p-22 -mr-75 bottom-0 right-0 z-10 dark:text-black">
            ...
            <p className="font-normal text-base/7 text-medium-gray">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip.</p>
            <Button text="Discover our story >" background="bg-yellow" color='text-black' func={ navigateToAboutUs }/>
          </div>
      </section>
      ...
      <section className="flex lg:flex-row xxs:flex-col lg:gap-24 xxs:gap-10 bg-light-yellow md:m-20 xxs:m-5 md:p-20 xxs:p-5 justify-center dark:text-black">
        <div className="flex flex-col gap-4 max-w-[345px]">
          ...
          <p className="font-normal text-base/7 text-medium-gray">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.</p>
          </div>
        <div className="bg-medium-gray w-[1px] h-[310px] hidden lg:block"></div>
