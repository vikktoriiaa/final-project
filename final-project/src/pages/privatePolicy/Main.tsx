  ...
  return (
    <main className="dark:bg-[#2e3040] dark:text-white">
      ...
      <section className="flex flex-col py-32 xl:px-[330px] gap-8 lg:px-[250px] md:px-[100px] xxs:px-[50px] xxs:py-10">
        <h3 className="font-bold lg:text-5xl/16 md:text-3xl/10 xs:text-2xl/8">Lorem ipsum dolor sit amet</h3>
        ...
        <h4 className="font-bold lg:text-4xl/12 md:text-3xl/10 xs:text-2xl/8">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.</h4>
