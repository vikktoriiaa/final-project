...
export const Main: FC = () => {
  return (
    <main>
      <section className="bg-[#F4F0F8] flex flex-col gap-1 py-20 px-[500px] text-center">
        <h3 className="font-bold text-5xl/16">Privacy Policy</h3>
        <p className="text-[#6D6E76] font-normal text-base/7">Last Updated  on 27th January 2022</p>
      </section>
      <section className="flex flex-col py-32 px-[330px] gap-8">
        <h3 className="font-bold text-5xl/16">Lorem ipsum dolor sit amet</h3>
        ...
        <h4 className="font-bold text-4xl/12">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.</h4>
