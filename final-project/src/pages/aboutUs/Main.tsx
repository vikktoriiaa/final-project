    ...
    <main className="dark:bg-[#2e3040] dark:text-white">
      ...
      <section className="flex flex-col justify-center items-center gap-12 px-20 lg:py-16 xxs:py-5">
        ...
        <div className="flex flex-wrap gap-8 justify-center items-stretch">
          ...
          <AuthorCard background="bg-[#F4F4F4]" icon="../../guy.svg" text="Content Writer @Company" title="Guy Hawkins" facebook="../../facebook.svg" twitter="../../twitter.svg" instagram="../../instagram.svg" linkedin="../../linkedin.svg" />
          <AuthorCard background="bg-[#F4F4F4]" icon="../../eleanor.svg" text="Content Writer @Company" title="Eleanor Pena" facebook="../../facebook.svg" twitter="../../twitter.svg" instagram="../../instagram.svg" linkedin="../../linkedin.svg" />
          <AuthorCard background="bg-[#F4F4F4]" icon="../../robert.svg" text="Content Writer @Company" title="Robert Fox" facebook="../../facebook.svg" twitter="../../twitter.svg" instagram="../../instagram.svg" linkedin="../../linkedin.svg" />
          <AuthorCard background="bg-[#F4F4F4]" icon="../../jacob.svg" text="Content Writer @Company" title="Jacob Jones" facebook="../../facebook.svg" twitter="../../twitter.svg" instagram="../../instagram.svg" linkedin="../../linkedin.svg" />
        </div>
      </section>
      <LastSection />
    </main>
